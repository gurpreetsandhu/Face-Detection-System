...
parser.add_argument('--num-epochs', default=10, type=int, metavar='NE',
                    help='number of epochs to train (default: 2)')
parser.add_argument('--num-classes', default=6, type=int, metavar='NC',
                    help='number of clases (default: 5)')
parser.add_argument('--num-train-triplets', default=1347, type=int, metavar='NTT',
                    help='number of triplets for training (default: 101)')
parser.add_argument('--num-valid-triplets', default=243, type=int, metavar='NVT',
                    help='number of triplets for vaidation (default: 70)')
parser.add_argument('--embedding-size', default=128, type=int, metavar='ES',
                    help='embedding size (default: 128)')
parser.add_argument('--batch-size', default=3, type=int, metavar='BS',
                    help='batch size (default: 128)')
parser.add_argument('--num-workers', default=-1, type=int, metavar='NW',
...
parser.add_argument('--train-root-dir', default=r'E:\Sem3\MC\Project\Dataset_used\output_resized\train', type=str,
                    help='path to train root dir')
parser.add_argument('--valid-root-dir', default=r'E:\Sem3\MC\Project\Dataset_used\output_resized\valid', type=str,
                    help='path to valid root dir')
parser.add_argument('--train-csv-name', default=r'E:\Sem3\MC\Project\Dataset_used\output_resized\train.csv', type=str,
                    help='list of training images')
parser.add_argument('--valid-csv-name', default=r'E:\Sem3\MC\Project\Dataset_used\output_resized\validation.csv', type=str,
...
def main():
    ...
    for epoch in range(args.start_epoch, args.num_epochs + args.start_epoch):
        ...
        print(args.train_root_dir,'----', args.valid_root_dir,'----',args.train_csv_name, args.valid_csv_name,'----',args.num_train_triplets, '----',args.num_valid_triplets,'----',args.batch_size, args.num_workers)
